...
public class SerieAController {
    ...
    void doSelezionaSquadra(ActionEvent event) {
    	...
    	if(t==null)
    	{
    		txtResult.appendText("ERRORE: selezionare squadra\n");
    		return;
    	}
    	
    	String ris= model.classifica(t);
    ...
    void doTrovaAnnataOro(ActionEvent event) {
    	if (flag==true)
    	{String ris= model.creaGrafo();
    	
    	txtResult.appendText(ris);}
    	
    	else { txtResult.appendText("Selezionare prima un Team e visualizzare le stagioni!\n");}
